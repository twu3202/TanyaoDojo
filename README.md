...
| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,在线值回归 + 锚定) | **跑中**(训练奖励改为评测同比例顺位点) | **-0.53 ± 1.32**(12k,λ=0.1 368,000 步;配对 vs C' final +0.25,z=0.38) | C' final 配对强于 rl1_best **+1.75(z=2.58)**;缺口定位在被飞对局,训练 pts=[6,4,2,0] 与评测 [90,45,0,-135] 不一致,正在验证,见 RESULTS「价值线 λ=0.1」节 |
