...
xychart-beta
    ...
    line [-2.50, -1.96, -14.29, -12.52, -8.87, -6.95, -5.63]
```

| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,DQN 式在线值回归) | 已退役 | **-1.96 ± 0.53**(100k) | 首破离线天花板 -2.50;anchor 守稳不涨后关线 |
| **Mahjax 线**(JAX 全 GPU 向量化,当前主线) | 进行中 | **-5.63 ± 2.66**(4k) | 8 天从零重建全栈;BC 三级火箭(容量/数据/obs)在燃,曲线未见顶 |
...
| 08-06 | **大网 × 14 年池 g1080** | **BC(全轨迹 4k 逐档选峰)** | **-5.63(新最优,停训点仍在涨)** |
