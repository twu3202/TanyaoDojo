...
| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,在线值回归 + 锚定) | **跑中**(奖励用评测口径顺位点) | **-0.93 ± 0.46**(**100k**,448,000 步;价值线此前唯一 100k 为 rl1_best -1.96) | 12k 曾到 +0.56,100k 回落到 -0.93,CI 整体 < 0。缺口几乎全在被飞提前结束的对局(-0.92 ± 0.26);408k 机制更平衡(副露 30.7、被飞差 +0.05),正在补跑 100k 决定下一步的锚 |
