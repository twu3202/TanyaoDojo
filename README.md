...
xychart-beta
    ...
    x-axis ["离线v11", "价值线rl1峰", "BC 20k场", "BC 353k场", "BC宽网192x8", "大网十年池", "大网14年池g1080"]
    y-axis "avg_pt vs v4" -16 --> 0
    line [-2.50, -1.96, -14.29, -12.52, -8.87, -6.95, -5.76]
```

| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,DQN 式在线值回归) | 已退役 | **-1.96 ± 0.53**(100k) | 首破离线天花板 -2.50;anchor 守稳不涨后关线 |
| **Mahjax 线**(JAX 全 GPU 向量化,当前主线) | 进行中 | **-5.76 ± 1.54**(12k) | 8 天从零重建全栈;BC 火箭两级已兑现,obs v2/精修/oracle 在弹匣 |
...
| 08-06 | **大网 × 14 年池 g1080** | **BC(逐档选峰,12k 局定音)** | **-5.76 ± 1.54(新最优)** |
