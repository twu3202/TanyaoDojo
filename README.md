...
| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,在线值回归 + 锚定) | **方案 A 跑中**(基座换成冠军 v4 自身) | **-0.64 ± 0.46**(100k,自建基座 408,000 步) | 缺口定位: 放铳率与 v4 持平但**每次放铳贵 90~125 点**(5 个快照同向)→ 下尾肥 → 自己被飞多 0.42pp(100k, 3σ), 而打满南四的对局我们赢 v4。容量假说被自家 192/256 对比否掉。2026-09-19 起从 mortal_v4 自身锚定微调(λ=0.2), avg_pt 直接就是净增量 |
