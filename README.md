...
xychart-beta
    ...
    x-axis ["离线v11", "价值线rl1峰", "BC 20k场", "BC 353k场", "BC宽网192x8", "大网256x10 ep1"]
    y-axis "avg_pt vs v4" -16 --> 0
    line [-2.50, -1.96, -14.29, -12.52, -8.87, -6.95]
```

| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,DQN 式在线值回归) | 已退役 | **-1.96 ± 0.53**(100k) | 首破离线天花板 -2.50;anchor 守稳不涨后关线 |
| **Mahjax 线**(JAX 全 GPU 向量化,当前主线) | 进行中 | **-6.95 ± 2.69**(4k) | 7 天从零重建全栈;BC 三级火箭(容量/数据/obs)在燃 |
...
| 08-04 | **大网 256×10 ep1** | **BC(十年池,val 81.2%)** | **-6.95(新最优)** |
| 在途 | 大网 ep2/ep3 | BC(足训中,今晚定标) | — |
