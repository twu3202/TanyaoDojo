...
| 线 | 状态 | 最优 | 备注 |
|---|---|---|---|
| **价值线**(Mortal 栈,在线值回归 + 锚定) | **续跑中**(锚 C' final,λ 0.1) | **-0.56 ± 1.30**(12k,锚 C' final 续跑 4.3 万步;与 C' final -0.75 配对 +0.22,z=0.36) | C' final 配对强于 rl1_best **+1.75(z=2.58)**;续跑若仍锚 rl1_best 会退回其打法(12k 配对 -1.26),锚住 C' final 才守住,见 RESULTS 末节 |
