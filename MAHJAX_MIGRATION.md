    ...
    **12k 定音 -5.90±1.54**、g570=-5.96。判定:**v2 以少 4 年数据、零精修站进
    ...
    - **四档 12k 定音**:g450=-6.18、g510=-5.90、c-g564=-5.64、**d-g720=-5.52±1.54**
      ...
      **判据前移到 v2 精修段**(lean 同一步白赚 +0.7pt):精修峰若仍不破 -5.0,
      ...
      算力全部转 oracle RL。
    - **精修在 v2 上失效(2026-08-16,同 seed 段可直接对比)**:lr 1e-4 从 d-g720
      精修一轮,4k 曲线 g186=-5.12 / g399=-5.25 / g612=-5.25 / g720=-6.66,
      **全部劣于精修前的 -4.43**(同为 seed10000 段)——lean 时期 +0.7pt 的红利
      未复现。结论:**obs v2 = 平局杠杆,BC 线收官**(最终冠军 lean g402 = -5.07±1.54,
      12k)。三个 BC 杠杆(容量/数据/观测)与两个训练技巧(轮次/精修)全部见底,
      -5 是模仿学习在本栈的天花板。**算力转 oracle RL**。
